...
int n_pecas=0,peca1,peca2,peca3,peca4,peca5,peca6,peca7,peca8;
...
int main(int argc, char *argv[]) {
    ...
    if(peca8 > peca7 || peca7>peca6 || peca6>peca5 || peca5>peca4 || peca4>peca3 || peca3>peca2 || peca2>peca1){ /* Restrição 3*/
    ...
    if(Modo_Posicionamento==1 && (peca8!=0 || peca7!=0 || peca6!=0 || peca5!=0 || peca4!=0 || peca3!=0 || peca2!=0 || peca1!=0)){
