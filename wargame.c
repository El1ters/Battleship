...
void Modo_Disparo2(int linha_disparo,int coluna_disparo){
			int ascii_convertion = coluna_disparo+65;
			int transfer_line = g_lines - linha_disparo;
			int numero_quadriculas_pecas=0;
			int total_squares;

			for(int a = -1;a<=1;a++){
				for(int b=-1;b<=1;b++){
					if(Tab[linha_disparo+a][coluna_disparo+b][1]!=0)
						numero_quadriculas_pecas++;
				}

			}
			printf("\n");
			Tab[linha_disparo][coluna_disparo][0] = 1;
			//printf("%c%d-\n",ascii_convertion,transfer_line);
				if(Tab[linha_disparo][coluna_disparo][1]!=0){	
					numero_quadriculas_pecas--;
									
				}
				if(numero_quadriculas_pecas==0){
					Tabuleiro();
					return;
				}	
			...
			//printf("%c%d-\n",ascii_convertion,transfer_line + 1);
			...
			//printf("%c%d-\n",ascii_convertion - 1,transfer_line);
			...
			//printf("%c%d-\n",ascii_convertion - 1,transfer_line + 1);
...
/*	if(Tab[linhas][colunas][1]!=0 && confirma_numero == 1){
			numero_quadriculas_pecas = Tab[linhas][colunas][1];
			printf("numero_quadriculas_pecas1:%d\n",numero_quadriculas_pecas);
			Tab[linhas][colunas][0]=1;
			numero_quadriculas_pecas--;
			confirma_numero--;
			printf("numero:%d\n",Tab[linhas][colunas][1]);
			
	}
	else if(Tab[linhas][colunas][1]!=0 && confirma_numero!=1){
		printf("numero_quadriculas_pecas2antes:%d\n",numero_quadriculas_pecas);
		numero_quadriculas_pecas--;
		printf("numero_quadriculas_pecas2depois:%d\n",numero_quadriculas_pecas);
	}
	printf("numero_quadriculas_pecas3:%d\n",numero_quadriculas_pecas);
	return numero_quadriculas_pecas;
