        ...
        for (int colunas = 1; colunas <= Colunas - 2; colunas += 3){
            ...
            for (int i = 0; i < 3; i++){
                ...
                while(Restricao1(tab)==0 && Modo_Posicionamento==2){/*Modo P2*/
                    if(ID==9 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 1 cabe*/
                        printf("%d-",ID);
                        AUX_P2[1]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[1]++;                       
                    }
                    if(ID==21 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 2 cabe*/
                        printf("%d-",ID);
                        AUX_P2[2]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[2]++; 
                    }
                    if(ID==27 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 3 cabe*/
                        printf("%d-",ID);
                        AUX_P2[3]=1;
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[3]++;                        
                    }
                    if(ID==31 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 4 cabe*/
                        printf("%d-",ID);
                        AUX_P2[4]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[4]++;                        
                    }
                    if(ID==35 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 5 cabe*/
                        printf("%d-",ID);
                        AUX_P2[5]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[5]++;
                    }
                    if(ID==39 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 6 cabe*/
                        printf("%d-",ID);
                        AUX_P2[6]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[6]++;
                    }
                    if(ID==41 && Restricao1(tab)==0){/*Verificar se a ultima variante da peça do tipo 7 cabe*/
                        printf("%d-",ID);
                        AUX_P2[7]=1; 
                        ID=Modo_P2(tab,Tipo_Peca,AUX_P2);
                        Tipo_Peca[7]++;
