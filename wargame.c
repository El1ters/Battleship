        ...
        for (int colunas = 1; colunas <= Colunas - 2; colunas += 3){
            ...
            for (int i = 0; i < 3; i++){/*como nas peças começa a preencher na posição 6, vai se somando 5 para apenas por na matriz as partes que interessa*/
                ...
                while(Restricao1(tab)==0 && Modo_Posicionamento==2){/*Modo P2*/
                    int ID42_AUX=0;
                    if(ID==9 || ID==21 || ID==27 || ID==31 || ID ==35 || ID == 39 || ID==41 || ID42_AUX!=0 && ID==42){
                            if(ID==9){
                                Tipo_Peca[1]++;
                            }
                            if(ID==21){
    ...
    int K=0;    
        while(K==0){
            int Rand=rand()%9;
                ...
                else if(Rand==1 && tipo_peca[1]>0){
                    ID=1;
                    K=1;
                    tipo_peca[1]--;
                }
                else if(Rand==2 && tipo_peca[2]>0){
                    ID=10;
                    K=1;
                    tipo_peca[2]--;
                }
                else if(Rand==3 && tipo_peca[3]>0){
                    ID=22;
                    K=1;
                    tipo_peca[3]--;
                }
                else if(Rand==4 && tipo_peca[4]>0){
                    ID=28;
                    K=1;
                    tipo_peca[4]--;
                }
                else if(Rand==5 && tipo_peca[5]>0){
                    ID=32;
                    K=1;
                    tipo_peca[5]--;
                }
                else if(Rand==6 && tipo_peca[6]>0){
                    ID=36;
                    K=1;
                    tipo_peca[6]--;
                }
                else if(Rand==7 && tipo_peca[7]>0){
                    ID=40;
                    K=1;
                    tipo_peca[7]--;
                }
                else if(Rand==8 && tipo_peca[8]>0){
                    ID=42;
                    K=1;
                    tipo_peca[8]--;
                }
